...
2) utils.py - This is an auxiliary package delveloped in house, becauase the routines in here are used by multiple scripts. This is the same utils.py file used in [https://github.com/cmcgrud1/JointParameterEstimation](url)
